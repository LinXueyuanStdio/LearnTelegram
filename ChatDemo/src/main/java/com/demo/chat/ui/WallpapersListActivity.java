...
import com.demo.chat.ui.Cells.TextCell;
import com.demo.chat.ui.Cells.WallpaperCell;
...
import com.demo.chat.ui.Components.WallpaperUpdater;
...
//                    ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(this::loadWallpapers));
    ...
    private boolean onItemLongClick(WallpaperCell view, Object object, int index) {
        if (actionBar.isActionModeShowed() || getParentActivity() == null || !(object instanceof WallPaper)) {
            return false;
        }
...
//        ConnectionsManager.getInstance(currentAccount).bindRequestToGuid(reqId, classGuid);
    ...
    private void fillWallpapersWithCustom() {
        ...
        Collections.sort(wallPapers, (o1, o2) -> {
            if (o1 instanceof WallPaper && o2 instanceof WallPaper) {
