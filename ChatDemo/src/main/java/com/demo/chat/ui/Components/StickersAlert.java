...
public class StickersAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface StickersAlertDelegate {
        void onStickerSelected(Document sticker, Object parent, boolean clearsInputField, boolean notify, int scheduleDate);
        boolean canSchedule();
    ...
    private void init(Context context) {
        ...
        stickersOnItemClickListener = (view, position) -> {
            if (stickerSetCovereds != null) {
                ...
                PhotoSize thumb = FileLoader.getClosestPhotoSizeWithSize(selectedSticker.thumbs, 90);
