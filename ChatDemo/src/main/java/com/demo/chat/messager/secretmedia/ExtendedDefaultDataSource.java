...
import com.demo.chat.messager.FileStreamLoadOperation;
...
public final class ExtendedDefaultDataSource implements DataSource {
     ...
     * @param allowCrossProtocolRedirects Whether cross-protocol redirects (i.e. redirects from HTTP
     *     to HTTPS and vice versa) are enabled when fetching remote data.
     * @deprecated Use {@link #ExtendedDefaultDataSource(Context, String, int, int, boolean)} and {@link
     *     #addTransferListener(TransferListener)}.
     */
    @Deprecated
    @SuppressWarnings("deprecation")
     ...
     * @param baseDataSource A {@link DataSource} to use for URI schemes other than file, asset and
     *     content. This {@link DataSource} should normally support at least http(s).
     * @deprecated Use {@link #ExtendedDefaultDataSource(Context, DataSource)} and {@link
     *     #addTransferListener(TransferListener)}.
     */
    @Deprecated
    public ExtendedDefaultDataSource(
