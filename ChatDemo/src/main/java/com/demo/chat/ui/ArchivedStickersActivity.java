...
import com.demo.chat.ui.Cells.ArchivedStickerSetCell;
import com.demo.chat.ui.Cells.LoadingCell;
import com.demo.chat.ui.Components.EmptyTextProgressView;
...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final LongSparseArray<StickerSetCovered> installingStickerSets = new LongSparseArray<>();
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            if (position >= stickersStartRow && position < stickersEndRow && getParentActivity() != null) {
                final StickerSetCovered stickerSet = sets.get(position - stickersStartRow);
...
//    }
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.needAddArchivedStickers) {
            final List<StickerSetCovered> newSets = new ArrayList<>((List<StickerSetCovered>) args[0]);
            ...
            if (listView != null) {
                for (int i = 0, size = listView.getChildCount(); i < size; i++) {
                    ...
                    if (view instanceof ArchivedStickerSetCell) {
                        ...
                        final StickerSetCovered stickersSet = cell.getStickersSet();
                        if (stickersSet != null) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (getItemViewType(position) == 0) {
                ...
                StickerSetCovered stickerSet = sets.get(stickerSetPosition);
