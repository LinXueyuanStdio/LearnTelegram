...
public class TableLayout extends View {
    ...
    public class Child {
        ...
        private Block.TL_pageTableCell cell;
        private int index;
    ...
    public interface TableLayoutDelegate {
        ArticleViewer.DrawingText createTextLayout(Block.TL_pageTableCell cell, int maxWidth);
        Paint getLinePaint();
    ...
    public void addChild(Block.TL_pageTableCell cell, int x, int y, int colspan) {
        if (colspan == 0) {
            colspan = 1;
        }
        Child child = new Child(childrens.size());
