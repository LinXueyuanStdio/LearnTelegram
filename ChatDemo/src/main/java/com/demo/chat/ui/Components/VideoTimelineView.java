...
public class VideoTimelineView extends View {
    ...
    public void setRoundFrames(boolean value) {
        isRoundFrames = value;
        if (isRoundFrames) {
            rect1 = new android.graphics.Rect(AndroidUtilities.dp(14), AndroidUtilities.dp(14), AndroidUtilities.dp(14 + 28), AndroidUtilities.dp(14 + 28));
            ...
            protected Bitmap doInBackground(Integer... objects) {
                ...
                try {
                    ...
                    if (bitmap != null) {
                        ...
                        android.graphics.Rect destRect = new Rect((frameWidth - w) / 2, (frameHeight - h) / 2, w, h);
