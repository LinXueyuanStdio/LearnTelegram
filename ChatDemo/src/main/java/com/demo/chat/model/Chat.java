...
public class Chat extends UserChat {
    ...
    public int read_inbox_max_id = 1;
    public int read_outbox_max_id = 1;
    public int unread_count = 1;
    public int migrated_from_chat_id = 1;
    public int migrated_from_max_id = 1;
    public int pinned_msg_id = 1;
    public int kicked_count = 1;
    public int unread_important_count = 1;
    public int folder_id = 1;
    ...
    public int online_count = 1;
    public StickerSet stickerset = new StickerSet();
    public int available_min_id = 1;
    public int call_msg_id = 1;
    public int linked_chat_id = 1;
