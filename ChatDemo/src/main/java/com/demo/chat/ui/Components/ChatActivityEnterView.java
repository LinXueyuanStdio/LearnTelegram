 ...
 * @description null
 * @usage null
 * 聊天窗口中发送消息界面部分。里面有发送消失按钮的监听事件、以及相关界面的绘制等。
 */
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    private void resizeForTopView(boolean show) {
        FrameLayout.LayoutParams layoutParams = (LayoutParams) textFieldContainer.getLayoutParams();
        ...
        emojiView.setDelegate(new EmojiView.EmojiViewDelegate() {
            ...
            public void onGifSelected(View view, Object gif, Object parent, boolean notify, int scheduleDate) {
                if (isInScheduleMode() && scheduleDate == 0) {
                    ...
                    } else if (gif instanceof BotInlineResult) {
                        BotInlineResult result = (BotInlineResult) gif;
            ...
            if (audio instanceof VideoEditedInfo) {
                ...
                if (audioToSend != null) {
                    ...
                    for (int a = 0; a < audioToSend.attributes.size(); a++) {
                        Document.DocumentAttribute attribute = audioToSend.attributes.get(a);
