package com.demo.chat.ui.Components.Paint.Views;
...
import com.demo.chat.ui.Components.Rect;
...
public class StickerView extends EntityView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) baseSize.width, View.MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec((int) baseSize.height, View.MeasureSpec.EXACTLY));
    }
