                ...
                if (scheduled) {
                    ...
                    for (int a = 0; a < count; a++) {
                        ...
                        if (load_type == -2) {
                            ...
                            if (exist = cursor.next()) {
                                ...
                                if (data != null) {
                                    ...
                                    if (oldMessage.media.isPhoto() && message.media.isPhoto() && oldMessage.media.photo != null && message.media.photo != null) {
                                        sameMedia = oldMessage.media.photo.id == message.media.photo.id;
                                    } else if (oldMessage.media.isDocument() && message.media.isDocument() && oldMessage.media.document != null && message.media.document != null) {
                        ...
                        if (MediaDataController.canAddMessageToMedia(message)) {
                            ...
                            state_media.bindByteBuffer(5, data);
                            state_media.step();
                        } else if (message!=null && message.action.isHistoryClear()) {
                            try {
