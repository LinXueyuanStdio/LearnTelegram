...
public class StickerSetCell extends FrameLayout {
    ...
    private MessagesStickerSet stickersSet;
    ...
    public void setStickersSet(MessagesStickerSet set, boolean divider) {
        needDivider = divider;
        stickersSet = set;
        ...
        if (documents != null && !documents.isEmpty()) {
            ...
            Document sticker = documents.get(0);
            Media object;
    ...
    public MessagesStickerSet getStickersSet() {
        return stickersSet;
    }
